    ...
    return (
        <section className='pt-[4.375rem]'>
            ...
            <div className='flex justify-center'>
                <div className='inline-flex items-center justify-between p-5 rounded-lg bg-gray-50'>
                    <div className='flex items-center gap-4'>
                        <div>
                            <h3 class="text-base text-text">
                                <strong class="font-bold">80k+</strong> Happy Users!</h3>
                            <p class="text-sm text-gray-500">#1 Tailwind CSS Admin Dashboard</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center gap-4 cursor-pointer group'>
                        ...
                        <div><h3 class="flex items-center gap-1 text-base text-text">
                            ...
                            <p class="text-sm text-gray-500">Show your support by giving us a star! 🌟</p>
                        </div>
                    </div>
                </div>
            </div>
